...
#GUI Variables
$FormTitleText = "Pulitore di discu da Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "Selezziunà u discu:"
$FreeSpaceLabelText = "Spaziu liberu (gigabyte): "
$TotalSpaceLabelText = "Spaziu tutale (gigabyte): "
$JunkFoundLabelText = "spazzatura trovata (gigabyte):"
$CleanDiskBtnText = "Pulisce u discu *Sguassà i schedari*"
$SpaceCleanedLabelText = "Spaziu pulitu (gigabyte): "
$LogFileLabelText = "File di logu trovu: $abcdefg"
$CreditLabelText = "Script di Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "Fichiu di logu trovu"
$AnalyzingDriveText = "Analisi di unità..."
$BrowsersAreRunningText = "I navigatori sò in esecuzione... Avvisà l'utilizatori..."
$PleaseCloseBrowsersText = "Per piacè chjude tutti i navigatori web è pruvate di novu."
$CleaningDriveText = "Pulizia di l'unità..."
